    ...
    <div class="flex w-10/12 mx-auto justify-center space-x-8">
        <form method="POST" action="{{ route('muebles.store') }}" class="max-w-sm mx-auto mt-6">
            ...
            <div class="mb-5">
                ...
                <x-text-input name="precio" type="text" min="1" id="precio" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    :value="old('precio')" />
            ...
            <div class="mb-5">
                ...
                <select name="tipo" type="text" id="tipo" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
